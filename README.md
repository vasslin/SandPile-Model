...
Пользоваться сторонними библиотеками, кроме стандартной, запрещено. Функции для работы с картинками в формате bmp необходимо спроектировать и реализовать самостоятельно.
